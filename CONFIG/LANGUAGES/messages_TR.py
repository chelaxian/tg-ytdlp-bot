...
Daha fazla bilgi: /playlist"""
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Porno önbellekleri admin {admin_id} tarafından yeniden yüklendi. Alan Adları: {domains}, Anahtar Kelimeler: {keywords}, Siteler: {sites}, BEYAZ LİSTE: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}"
