...
<i>Mevcut hizmetler bot yapılandırmasına bağlıdır.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Varsayilan dublaj (ses parcasi) dili"
    ...
    DUBS_SETTINGS_MENU_MSG = "🗣 <b>Dublaj (ses parçası) ayarları</b>\n\n{status_text}\n\nDublaj dilini seçin:\n\n"
