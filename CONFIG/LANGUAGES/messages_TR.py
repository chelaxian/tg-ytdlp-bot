...
• <code>/nsfw off</code> - bulanıklığı etkinleştir
    ...
    SIZE_LIMIT_EXCEEDED = "❌ Dosya boyutu __VAR_0__ GB sınırını aşıyor. Lütfen izin verilen boyut dahilinde daha küçük bir dosya seçin."
    ...
    CHANNEL_GUARD_ACTIVITY_SUMMARY_MSG = "📝 Son {hours} saat (2 gün): {joined} katıldı, __VAR_0__ kaldı."
    ...
    SPLIT_SIZE_SET_CALLBACK_LOG_MSG = "Bölme boyutu __VAR_0__ bayt olarak ayarlandı."
    ...
    SPLIT_SIZE_SET_CALLBACK_LOG_MSG = "Bölünmüş parça boyutu __VAR_0__ bayt olarak ayarlandı."
    ...
    DB_ERROR_RUNNING_AUTO_RELOAD_MSG = "❌ Auto reload_cache çalıştırılırken hata oluştu (__VAR_2__/__VAR_1__ denemesi): {error}"
    ...
    DB_USER_BANNED_MSG = "🚫 Bottan yasaklandınız!"
