...
• <code>/nsfw off</code> - Unschärfe aktivieren
    ...
    UPLOAD_ALREADY_IN_PROGRESS_MSG = "⏳ Dieses Video wird bereits hochgeladen. Bitte warten Sie, bis der aktuelle Upload abgeschlossen ist."
    FLOOD_WAIT_USER_MSG = "Telegram erfordert eine Wartezeit vor dem Senden. Der Bot wird nach Ablauf des Timers automatisch fortfahren ({time_str})."
...
Mehr erfahren: /playlist"""
    ...
    FORMAT_RESOLUTION_MENU_MSG = "Wählen Sie Ihre gewünschte Auflösung und Codec:\n\n⚠️ <b>MKV/AV1/VP9:</b> Zur Wiedergabe aktivieren Sie <b>PlayerV2</b> im Telegram-Debug-Menü:\n📱 iOS: Settings → 10-mal tippen → PlayerV2-Schalter\n🤖 Android: Settings → \"Telegram v X.X.X\" zweimal lang drücken → Debug-Menü"
    FORMAT_ALWAYS_ASK_CONFIRM_MSG = "✅ Format auf gesetzt: Always Ask. Jetzt werden Sie jedes Mal nach der Qualität gefragt, wenn Sie eine URL senden."
    ...
    ALWAYS_ASK_SUB_BURN_PAID_MSG = "⭐️ — Fest eingebrannte Untertitel sind kostenpflichtig: 144p: 1⭐ | 240p: 2⭐ | 360p: 3⭐ | 480p: 4⭐ | 720p: 5⭐ | 1080p+: nur Admin"
    ...
    ALWAYS_ASK_MKV_PLAYER_HINT_MSG = "⚠️ MKV/AV1/VP9: PlayerV2 im Telegram-Debug-Menü aktivieren für Inline-Wiedergabe\niOS: 10× auf Settings tippen → nach unten scrollen → PlayerV2 umschalten\nAndroid: Settings → zweimal lange drücken auf \"Telegram v X.X.X\" → Debug-Menü"
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>MKV/AV1/VP9-Video</b>\nUm dieses Video abzuspielen, aktivieren Sie <b>PlayerV2</b> im Telegram-Debug-Menü:\n\n📱 <b>iOS</b>: Settings → 10× tippen → nach unten scrollen → PlayerV2 aktivieren\n🤖 <b>Android</b>: Settings → nach unten scrollen → zweimal lange drücken auf \"Telegram v X.X.X\" → PlayerV2 aktivieren"
    ...
    PROXY_COUNTRY_NOT_AVAILABLE_MSG = "❌ Proxy für dieses Land nicht verfügbar. Versuchen Sie ein anderes Land."
    PROXY_COUNTRY_SET_BY_COMMAND_MSG = "✅ Proxy gesetzt: Land {country} (Code: {country_code})"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Porn-Caches von Admin {admin_id} neu geladen. Domains: {domains}, Keywords: {keywords}, Sites: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>Verfügbare Dienste hängen von der Bot-Konfiguration ab.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Standard-Synchronisation (Audiospur) Sprache"
