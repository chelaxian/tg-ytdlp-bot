...
Ko'proq ma'lumot: /playlist"""
    ...
    ALWAYS_ASK_SUB_BURN_PAID_MSG = "⭐️ — Kuydirilgan subtitrlar pullik: 144p: 1⭐ | 240p: 2⭐ | 360p: 3⭐ | 480p: 4⭐ | 720p: 5⭐ | 1080p+: faqat admin"
    ...
    ALWAYS_ASK_MKV_PLAYER_HINT_MSG = "⚠️ MKV/AV1/VP9: ijro etish uchun Telegram Debug menusida PlayerV2'ni yoqing\niOS: Settings'ga 10 marta tegining → pastga aylantiring → PlayerV2'ni yoqing\nAndroid: Settings → \"Telegram v X.X.X\" qatorini ikki marta uzoq bosing → Debug menusi"
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>MKV/AV1/VP9 video</b>\nBu videoni ijro etish uchun Telegram Debug menusida <b>PlayerV2</b>'ni yoqing:\n\n📱 <b>iOS</b>: Settings → 10 marta tegining → pastga aylantiring → PlayerV2'ni yoqing\n🤖 <b>Android</b>: Settings → pastga aylantiring → \"Telegram v X.X.X\" qatorini ikki marta uzoq bosing → PlayerV2'ni yoqing"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Porn keshlari admin {admin_id} tomonidan qayta yuklandi. Domenlar: {domains}, Kalit so'zlar: {keywords}, Saytlar: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>Mavjud xizmatlar bot konfiguratsiyasiga bog'liq.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Standart dublyaj (audio treki) tili"
