...
Tìm hiểu thêm: /playlist"""
    ...
    FORMAT_RESOLUTION_MENU_MSG = "Chọn độ phân giải và codec mong muốn của bạn:\n\n⚠️ <b>MKV/AV1/VP9:</b> Để phát định dạng này, hãy bật <b>PlayerV2</b> trong menu Debug của Telegram:\n📱 iOS: Settings → nhấn 10 lần → bật PlayerV2\n🤖 Android: Settings → nhấn giữ \"Telegram v X.X.X\" hai lần → menu Debug"
    FORMAT_ALWAYS_ASK_CONFIRM_MSG = "✅ Định dạng đã đặt thành: Luôn Hỏi. Bây giờ bạn sẽ được nhắc về chất lượng mỗi khi gửi URL."
    ...
    ALWAYS_ASK_MKV_PLAYER_HINT_MSG = "⚠️ MKV/AV1/VP9: bật PlayerV2 trong menu Debug của Telegram để phát trực tiếp\niOS: Nhấn Settings 10 lần → cuộn xuống → bật PlayerV2\nAndroid: Settings → nhấn giữ hai lần vào \"Telegram v X.X.X\" → menu Debug"
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>Video MKV/AV1/VP9</b>\nĐể phát video này, hãy bật <b>PlayerV2</b> trong menu Debug của Telegram:\n\n📱 <b>iOS</b>: Settings → nhấn 10 lần → cuộn xuống → bật PlayerV2\n🤖 <b>Android</b>: Settings → cuộn xuống → nhấn giữ hai lần vào \"Telegram v X.X.X\" → bật PlayerV2"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Cache porn đã được tải lại bởi admin {admin_id}. Domain: {domains}, Từ khóa: {keywords}, Trang web: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>Các dịch vụ có sẵn phụ thuộc vào cấu hình bot.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Ngon ngu long tieng (ranh am thanh) mac dinh"
