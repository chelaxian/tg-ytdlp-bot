...
• <code>/nsfw off</code> - เปิดใช้งานเบลอ
    ...
    PROXY_ENABLED_MSG = "✅ พร็อกซี __VAR_0__."
    ...
    MEDIAINFO_ENABLED_MSG = "✅ มีเดียอินโฟ __VAR_0__."
    ...
    ADMIN_DOWNLOADING_MSG = "⏳ กำลังดาวน์โหลด Firebase dump ใหม่โดยใช้ __VAR_0__ ..."
    ADMIN_CACHE_RELOADED_MSG = "✅ โหลดแคช Firebase สำเร็จแล้ว!"
    ADMIN_CACHE_FAILED_MSG = "❌ ไม่สามารถโหลดแคช Firebase ใหม่ได้ ตรวจสอบว่า __VAR_0__ มีอยู่หรือไม่"
    ...
    CHANNEL_GUARD_PENDING_MORE_MSG = "… และ __VAR_0__ ผู้ใช้เพิ่มขึ้น"
    ...
    CHANNEL_GUARD_ACTIVITY_FILE_CAPTION_MSG = "🗂 บันทึกกิจกรรมของช่องสำหรับ __VAR_0__ ชั่วโมงที่ผ่านมา (2 วัน)"
    CHANNEL_GUARD_ACTIVITY_SUMMARY_MSG = "dict __VAR_2__ ชั่วโมงล่าสุด (2 วัน): เข้าร่วม __VAR_1__ ออกไป {left}"
    CHANNEL_GUARD_ACTIVITY_EMPTY_MSG = "ℹ️ ไม่มีกิจกรรมในช่วง __VAR_0__ ชั่วโมงที่ผ่านมา (2 วัน)"
    ...
    BAN_TIME_SET_MSG = "🕒 ตั้งค่าช่วงเวลาการสแกนบันทึกช่องเป็น __VAR_0__"
    BAN_TIME_REPORT_MSG = (
    ...
    ADMIN_ERROR_RELOADING_PORN_MSG = "❌ เกิดข้อผิดพลาดในการโหลดแคชสื่อลามกซ้ำ: __VAR_0__"
    ...
    COOKIES_SOURCE_NOT_CONFIGURED_MSG = "❌ __VAR_0__ แหล่งที่มาของคุกกี้ไม่ได้กำหนดค่า!"
    COOKIES_SOURCE_MUST_BE_TXT_MSG = "❌ __VAR_0__ แหล่งที่มาของคุกกี้ต้องเป็นไฟล์ .txt!"
    ...
    KEYBOARD_SET_TO_MSG = "ตั้งค่าแป้นพิมพ์เป็น __VAR_0__"
    ...
    COOKIES_INVALID_YOUTUBE_INDEX_MSG = "❌ ดัชนีคุกกี้ YouTube ไม่ถูกต้อง: {selected_index} ช่วงที่ใช้ได้คือ 1-__VAR_0__"
    ...
    COOKIES_FALLBACK_UNEXPECTED_ERROR_LOG_MSG = "ข้อผิดพลาดสำรอง COOKIE_URL ที่ไม่คาดคิด: __VAR_1__: {error}"
    COOKIES_BROWSER_NOT_INSTALLED_LOG_MSG = "ไม่ได้ติดตั้งเบราว์เซอร์ __VAR_0__"
    COOKIES_SAVED_BROWSER_LOG_MSG = "คุกกี้ที่บันทึกโดยใช้เบราว์เซอร์: {browser}"
    COOKIES_FILE_SAVED_USER_LOG_MSG = "ไฟล์คุกกี้ที่บันทึกไว้สำหรับผู้ใช้ __VAR_0__"
    ...
    ADMIN_ERROR_RELOADING_CACHE_LOG_MSG = "เกิดข้อผิดพลาดในการโหลดแคช Firebase ใหม่: __VAR_0__"
    ...
    ADMIN_CACHE_CLEARED_LOG_MSG = "ผู้ดูแลระบบ __VAR_1__ ล้างแคชสำหรับ URL: {url}"
    ADMIN_PORN_UPDATE_STARTED_LOG_MSG = "ผู้ดูแลระบบ __VAR_1__ เริ่มต้นสคริปต์อัปเดตรายการสื่อลามก: {script_path}"
    ADMIN_PORN_UPDATE_COMPLETED_LOG_MSG = "สคริปต์อัปเดตรายการโป๊เสร็จสมบูรณ์โดยผู้ดูแลระบบ __VAR_0__"
    ADMIN_PORN_UPDATE_FAILED_LOG_MSG = "สคริปต์อัปเดตรายการอนาจารล้มเหลวโดยผู้ดูแลระบบ __VAR_1__: __VAR_0__"
    ADMIN_SCRIPT_NOT_FOUND_LOG_MSG = "ผู้ดูแลระบบ __VAR_1__ พยายามเรียกใช้สคริปต์ที่ไม่มีอยู่จริง: {script_path}"
    ADMIN_PORN_UPDATE_ERROR_LOG_MSG = "เกิดข้อผิดพลาดในการเรียกใช้สคริปต์อัปเดตสื่อลามกโดยผู้ดูแลระบบ __VAR_1__: __VAR_0__"
    ADMIN_PORN_CACHE_RELOAD_STARTED_LOG_MSG = "ผู้ดูแลระบบ {user_id} เริ่มโหลดแคชเนื้อหาลามกใหม่"
    ADMIN_PORN_CACHE_RELOAD_ERROR_LOG_MSG = "เกิดข้อผิดพลาดในการโหลดแคชสื่อลามกซ้ำโดยผู้ดูแลระบบ __VAR_1__: __VAR_0__"
    ADMIN_PORN_CHECK_LOG_MSG = "ผู้ดูแลระบบ __VAR_2__ ตรวจสอบ URL สำหรับ NSFW: {url} - ผลลัพธ์: {status}"
    ...
    # Link log messages
    LINK_EXTRACTED_LOG_MSG = "แยกลิงก์โดยตรงสำหรับผู้ใช้ __VAR_1__ จาก __VAR_0__"
    LINK_EXTRACTION_FAILED_LOG_MSG = "ไม่สามารถแยกลิงก์โดยตรงสำหรับผู้ใช้ __VAR_2__ จาก __VAR_1__: {error}"
    LINK_COMMAND_ERROR_LOG_MSG = "เกิดข้อผิดพลาดในคำสั่งลิงก์สำหรับผู้ใช้ {user_id}: {error}"
    
    # Keyboard log messages
    KEYBOARD_SET_LOG_MSG = "ผู้ใช้ __VAR_1__ ตั้งค่าแป้นพิมพ์เป็น {setting}"
    KEYBOARD_SET_CALLBACK_LOG_MSG = "ผู้ใช้ __VAR_1__ ตั้งค่าแป้นพิมพ์เป็น {setting}"
    ...
    DIRECT_LINK_MENU_CREATED_LOG_MSG = "เมนูลิงก์โดยตรงที่สร้างผ่านปุ่ม LINK สำหรับผู้ใช้ __VAR_1__ จาก __VAR_0__"
    DIRECT_LINK_EXTRACTION_FAILED_LOG_MSG = "ไม่สามารถแยกลิงก์โดยตรงผ่านปุ่ม LINK สำหรับผู้ใช้ __VAR_2__ จาก __VAR_1__: {error}"
    LIST_COMMAND_EXECUTED_LOG_MSG = "คำสั่ง LIST ดำเนินการสำหรับผู้ใช้ {user_id}, url: {url}"
    QUICK_EMBED_LOG_MSG = "ฝังด่วน: {embed_url}"
    ALWAYS_ASK_MENU_SENT_LOG_MSG = "ส่งเมนูถามเสมอสำหรับ __VAR_0__"
    CACHED_QUALITIES_MENU_CREATED_LOG_MSG = "สร้างเมนูคุณสมบัติแคชสำหรับผู้ใช้ __VAR_1__ หลังจากข้อผิดพลาด: __VAR_0__"
    ...
    DOWN_UP_SPLITTED_PART_UPLOADED_MSG = "📤 อัปโหลดไฟล์ส่วนที่แยก __VAR_0__ แล้ว"
    ...
    DIRECT_LINK_EXTRACTED_ALWAYS_ASK_LOG_MSG = "แยกลิงก์โดยตรงผ่านเมนูถามเสมอสำหรับผู้ใช้ __VAR_1__ จาก __VAR_0__"
    DIRECT_LINK_FAILED_ALWAYS_ASK_LOG_MSG = "ไม่สามารถแยกลิงก์โดยตรงผ่านเมนูถามเสมอสำหรับผู้ใช้ __VAR_2__ จาก __VAR_1__: {error}"
    DIRECT_LINK_EXTRACTED_DOWN_UP_LOG_MSG = "ลิงก์โดยตรงที่แยกออกมาผ่าน down_and_up_with_format สำหรับผู้ใช้ __VAR_1__ จาก {url}"
    DIRECT_LINK_FAILED_DOWN_UP_LOG_MSG = "ไม่สามารถแยกลิงก์โดยตรงผ่าน down_and_up_with_format สำหรับผู้ใช้ __VAR_2__ จาก __VAR_1__: {error}"
    DIRECT_LINK_EXTRACTED_DOWN_AUDIO_LOG_MSG = "ลิงก์โดยตรงที่แยกออกมาผ่าน down_and_audio สำหรับผู้ใช้ __VAR_1__ จาก __VAR_0__"
    DIRECT_LINK_FAILED_DOWN_AUDIO_LOG_MSG = "ไม่สามารถแยกลิงก์โดยตรงผ่าน down_and_audio สำหรับผู้ใช้ __VAR_2__ จาก __VAR_1__: {error}"
    ...
    AUDIO_UNSUPPORTED_FILE_TYPE_MSG = "ข้ามประเภทไฟล์ที่ไม่รองรับในเพลย์ลิสต์ที่ดัชนี __VAR_0__"
    ...
    PAGE_NUMBER_MSG = "หน้า __VAR_0__"
    ...
    LIVE_STREAM_CHUNK_NUMBER_MSG = "ก้อน __VAR_0__"
    LIVE_STREAM_CHUNK_SIZE_MSG = "ขนาดสูงสุด: __VAR_0__"
    ...
    LIVE_STREAM_CHUNK_TITLE_MSG = "ก้อน __VAR_0__"
    ...
    COOKIES_DOWNLOAD_UNEXPECTED_ERROR_LOG_MSG = "เกิดข้อผิดพลาดที่ไม่คาดคิดขณะดาวน์โหลด {service} คุกกี้ (ซ่อน URL): __VAR_1__: {error}"
    COOKIES_FILE_UPDATED_LOG_MSG = "อัปเดตไฟล์คุกกี้สำหรับผู้ใช้ __VAR_0__"
    COOKIES_INVALID_CONTENT_LOG_MSG = "เนื้อหาคุกกี้ที่จัดทำโดยผู้ใช้ __VAR_0__ ไม่ถูกต้อง"
    COOKIES_YOUTUBE_URLS_EMPTY_LOG_MSG = "URL คุกกี้ของ YouTube ว่างเปล่าสำหรับผู้ใช้ __VAR_0__"
    COOKIES_YOUTUBE_DOWNLOADED_VALIDATED_LOG_MSG = "คุกกี้ YouTube ดาวน์โหลดและตรวจสอบความถูกต้องสำหรับผู้ใช้ {user_id} จากแหล่งที่มา __VAR_0__"
    COOKIES_YOUTUBE_ALL_FAILED_LOG_MSG = "แหล่งที่มาของคุกกี้ YouTube ทั้งหมดล้มเหลวสำหรับผู้ใช้ __VAR_0__"
    ADMIN_CHECK_PORN_ERROR_LOG_MSG = "เกิดข้อผิดพลาดในคำสั่ง check_porn โดยผู้ดูแลระบบ __VAR_1__: __VAR_0__"
    ...
    SKIPPING_UNSUPPORTED_FILE_TYPE_MSG = "ข้ามประเภทไฟล์ที่ไม่รองรับในเพลย์ลิสต์ที่ดัชนี __VAR_0__"
    ...
    DOWN_UP_NO_VIDEOS_PLAYLIST_MSG = "❌ ไม่พบวิดีโอในเพลย์ลิสต์ที่ดัชนี __VAR_0__"
    ...
    DOWN_UP_NO_CONTENT_FOUND_MSG = "❌ ไม่พบเนื้อหาที่ดัชนี __VAR_0__"
    ...
    AA_ERROR_CODEC_NOT_AVAILABLE_MSG = "❌ __VAR_0__ ตัวแปลงสัญญาณไม่พร้อมใช้งานสำหรับวิดีโอนี้"
    AA_ERROR_FORMAT_NOT_AVAILABLE_MSG = "❌ __VAR_0__ รูปแบบไม่พร้อมใช้งานสำหรับวิดีโอนี้"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "แคชสื่อลามกโหลดซ้ำโดยผู้ดูแลระบบ __VAR_11__ โดเมน: {domains}, คำสำคัญ: {keywords}, ไซต์: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}"
    ...
    COOKIES_BROWSER_CALLBACK_MSG = "[เบราว์เซอร์] โทรกลับ: __VAR_0__"
    COOKIES_ADDING_BROWSER_MONITORING_MSG = "การเพิ่มปุ่มตรวจสอบเบราว์เซอร์ด้วย URL: {miniapp_url}"
    COOKIES_BROWSER_MONITORING_URL_NOT_CONFIGURED_MSG = "URL การตรวจสอบเบราว์เซอร์ไม่ได้กำหนดค่า: __VAR_0__"
    ...
    LINK_USING_WORKING_YOUTUBE_COOKIES_MSG = "การใช้คุกกี้ YouTube ที่ใช้งานได้เพื่อแยกลิงก์สำหรับผู้ใช้ __VAR_0__"
    LINK_NO_WORKING_YOUTUBE_COOKIES_MSG = "ไม่มีคุกกี้ YouTube ที่ใช้งานได้สำหรับการดึงลิงก์สำหรับผู้ใช้ __VAR_0__"
    LINK_USING_EXISTING_YOUTUBE_COOKIES_MSG = "การใช้คุกกี้ YouTube ที่มีอยู่เพื่อแยกลิงก์สำหรับผู้ใช้ __VAR_0__"
    LINK_NO_YOUTUBE_COOKIES_FOUND_MSG = "ไม่พบคุกกี้ YouTube สำหรับการดึงลิงก์สำหรับผู้ใช้ __VAR_0__"
    LINK_COPIED_GLOBAL_COOKIE_FILE_MSG = "คัดลอกไฟล์ cookie ส่วนกลางไปยังโฟลเดอร์ผู้ใช้ {user_id} สำหรับการสกัดลิงก์"
    
    # MediaInfo command additional messages
    MEDIAINFO_USER_REQUESTED_MSG = "[MEDIAINFO] ผู้ใช้ __VAR_0__ ขอคำสั่ง mediainfo"
    MEDIAINFO_USER_IS_ADMIN_MSG = "[MEDIAINFO] ผู้ใช้ __VAR_1__ คือผู้ดูแลระบบ: {is_admin}"
    MEDIAINFO_USER_IS_IN_CHANNEL_MSG = "[MEDIAINFO] ผู้ใช้ {user_id} อยู่ในช่อง: {is_in_channel}"
    MEDIAINFO_ACCESS_DENIED_MSG = "[MEDIAINFO] การเข้าถึงของผู้ใช้ __VAR_0__ ถูกปฏิเสธ - ไม่ใช่ผู้ดูแลระบบและไม่ได้อยู่ในช่อง"
    ...
    DB_REST_TOKEN_REFRESH_ERROR_MSG = "❌ ข้อผิดพลาดในการรีเฟรชโทเค็น REST: __VAR_0__"
    DB_ERROR_CLOSING_SESSION_MSG = "❌ เกิดข้อผิดพลาดในการปิดเซสชัน Firebase: {error}"
    DB_ERROR_INITIALIZING_BASE_MSG = "❌ เกิดข้อผิดพลาดในการเริ่มต้นโครงสร้าง db ฐาน: __VAR_0__"
    ...
    DB_STARTING_FIREBASE_DUMP_MSG = "🔄 เริ่มดาวน์โหลด Firebase dump ที่ __VAR_0__"
    ...
    RESTORE_BACKUP_NOT_FOUND_MSG = "❌ ไม่พบข้อมูลสำรอง __VAR_0__ ใน _backup/"
    RESTORE_FAILED_RESTORE_MSG = "❌ ไม่สามารถกู้คืน {src} -> __VAR_1__: {e}"
    ...
    AUDIO_TIKTOK_API_ERROR_SKIP_MSG = "⚠️ ข้อผิดพลาด TikTok API ที่ดัชนี __VAR_0__ กำลังข้ามไปยังเสียงถัดไป..."
    
    # Video download messages  
    VIDEO_TIKTOK_API_ERROR_SKIP_MSG = "⚠️ ข้อผิดพลาด TikTok API ที่ดัชนี __VAR_0__ กำลังข้ามไปยังวิดีโอถัดไป..."
    ...
    # Gallery-dl messages
    GALLERY_DL_SKIPPING_NON_DICT_CONFIG_MSG = "ข้ามส่วนการกำหนดค่าที่ไม่ใช่ dict: __VAR_1__={opts}"
    GALLERY_DL_SETTING_CONFIG_MSG = "การตั้งค่า __VAR_2__.__VAR_1__ = {value}"
    GALLERY_DL_USING_USER_COOKIES_MSG = "[gallery-dl] การใช้คุกกี้ของผู้ใช้: __VAR_0__"
    ...
    GALLERY_DL_USING_COPIED_GLOBAL_COOKIES_MSG = "[gallery-dl] การใช้คุกกี้ส่วนกลางที่คัดลอกมาเป็นคุกกี้ของผู้ใช้: __VAR_0__"
    GALLERY_DL_FAILED_COPY_GLOBAL_COOKIE_MSG = "ไม่สามารถคัดลอกไฟล์คุกกี้ส่วนกลางสำหรับผู้ใช้ __VAR_1__: __VAR_0__"
    GALLERY_DL_USING_NO_COOKIES_MSG = "การใช้ --no-cookies สำหรับโดเมน: {url}"
    GALLERY_DL_PROXY_REQUESTED_FAILED_MSG = "พร็อกซีร้องขอแต่ล้มเหลวในการนำเข้า/รับการกำหนดค่า: __VAR_0__"
    GALLERY_DL_FORCE_USING_PROXY_MSG = "บังคับให้ใช้พร็อกซีสำหรับ gallery-dl: __VAR_0__"
    GALLERY_DL_PROXY_CONFIG_INCOMPLETE_MSG = "ร้องขอพร็อกซี่แต่การกำหนดค่าพร็อกซี่ไม่สมบูรณ์"
    GALLERY_DL_PROXY_HELPER_FAILED_MSG = "ตัวช่วยพร็อกซีล้มเหลว: __VAR_0__"
    GALLERY_DL_PARSING_EXTRACTOR_ITEMS_MSG = "กำลังแยกวิเคราะห์รายการแยกวิเคราะห์..."
    GALLERY_DL_ITEM_COUNT_MSG = "รายการ __VAR_1__: __VAR_0__"
    ...
    GALLERY_DL_SETTING_CONFIG_MSG2 = "การตั้งค่าการกำหนดค่า gallery-dl: __VAR_0__"
    ...
    GALLERY_DL_FAILED_SET_COOKIES_ON_EXTRACTOR_MSG = "ไม่สามารถตั้งค่าคุกกี้บนตัวแยก: __VAR_0__"
    ...
    SENDER_FFPROBE_BYPASS_ERROR_MSG = "[FFPROBE BYPASS] เกิดข้อผิดพลาดขณะประมวลผลวิดีโอ__VAR_1__: __VAR_0__"
    ...
    YTDLP_SKIPPING_MATCH_FILTER_MSG = "ข้าม match_filter สำหรับโดเมนใน NO_FILTER_DOMAINS: __VAR_0__"
    YTDLP_CHECKING_EXISTING_YOUTUBE_COOKIES_MSG = "ตรวจสอบคุกกี้ YouTube ที่มีอยู่ใน URL ของผู้ใช้เพื่อตรวจหารูปแบบสำหรับผู้ใช้ __VAR_0__"
    ...
    YTDLP_EXISTING_YOUTUBE_COOKIES_FAILED_MSG = "คุกกี้ YouTube ที่มีอยู่ล้มเหลวใน URL ของผู้ใช้ พยายามรับคุกกี้ใหม่สำหรับการตรวจจับรูปแบบสำหรับผู้ใช้ __VAR_0__"
    YTDLP_TRYING_YOUTUBE_COOKIE_SOURCE_MSG = "ลองใช้แหล่งที่มาของคุกกี้ YouTube {i} เพื่อการตรวจจับรูปแบบสำหรับผู้ใช้ __VAR_0__"
    ...
    YTDLP_YOUTUBE_COOKIES_FROM_SOURCE_DONT_WORK_MSG = "คุกกี้ YouTube จากแหล่งที่มา __VAR_1__ ใช้ไม่ได้กับ URL ของผู้ใช้สำหรับการตรวจจับรูปแบบสำหรับผู้ใช้ __VAR_0__"
    YTDLP_FAILED_DOWNLOAD_YOUTUBE_COOKIES_MSG = "ไม่สามารถดาวน์โหลดคุกกี้ YouTube จากแหล่งที่มา __VAR_1__ เพื่อการตรวจจับรูปแบบสำหรับผู้ใช้ __VAR_0__"
    ...
    YTDLP_USING_YOUTUBE_COOKIES_ALREADY_VALIDATED_MSG = "การใช้คุกกี้ YouTube เพื่อตรวจจับรูปแบบสำหรับผู้ใช้ __VAR_0__ (ตรวจสอบแล้วในเมนูถามเสมอ)"
    YTDLP_NO_YOUTUBE_COOKIES_FOUND_ATTEMPTING_RESTORE_MSG = "ไม่พบคุกกี้ YouTube สำหรับการตรวจจับรูปแบบสำหรับผู้ใช้ __VAR_0__ กำลังพยายามกู้คืน..."
    YTDLP_COPIED_GLOBAL_COOKIE_FILE_MSG = "คัดลอกไฟล์ cookie ส่วนกลางไปยังโฟลเดอร์ผู้ใช้ {user_id} สำหรับการตรวจจับรูปแบบ"
    YTDLP_FAILED_COPY_GLOBAL_COOKIE_FILE_MSG = "ไม่สามารถคัดลอกไฟล์คุกกี้ส่วนกลางสำหรับผู้ใช้ __VAR_1__: __VAR_0__"
    YTDLP_USING_NO_COOKIES_FOR_DOMAIN_MSG = "การใช้ --no-cookies สำหรับโดเมนใน get_video_formats: {url}"
    
    # App instance messages
    APP_INSTANCE_NOT_INITIALIZED_MSG = "แอปยังไม่ได้เริ่มต้น ไม่สามารถเข้าถึง __VAR_0__"
    ...
    CAPTION_UNEXPECTED_ERROR_IN_CAPTION_EDITOR_MSG = "ข้อผิดพลาดที่ไม่คาดคิดใน Caption_editor: __VAR_0__"
    CAPTION_VIDEO_URL_LINK_MSG = '<a href="{url}">🔗 URL ของวิดีโอ</a>{bot_mention}'
    ...
    DB_RELOAD_CACHE_EVERY_PERSISTED_MSG = "RELOAD_CACHE_EVERY ยืนยันเป็น config.py: __VAR_0__h"
    ...
    DB_GET_CACHED_PLAYLIST_COUNT_FAST_COUNT_MSG = "get_cached_playlist_count: นับอย่างรวดเร็วสำหรับช่วงขนาดใหญ่: __VAR_0__ วิดีโอที่แคชไว้"
    DB_GET_CACHED_MESSAGE_IDS_NO_CACHE_MSG = "get_cached_message_ids: ไม่พบแคชสำหรับแฮช __VAR_1__ คุณภาพ __VAR_0__"
    ...
    DB_AUTO_CACHE_RELOAD_ENABLED_LOG_MSG = "เปิดใช้งานการโหลดซ้ำอัตโนมัติ; ถัดไปที่ __VAR_0__"
    DB_AUTO_CACHE_RELOAD_DISABLED_LOG_MSG = "โหลดอัตโนมัติปิดการใช้งานโดยผู้ดูแลระบบ"
    DB_AUTO_CACHE_INTERVAL_SET_LOG_MSG = "ตั้งค่าช่วงการรีโหลดอัตโนมัติเป็น __VAR_1__h; ถัดไปที่ __VAR_0__"
    DB_AUTO_CACHE_RELOAD_STARTED_LOG_MSG = "เริ่มโหลดอัตโนมัติแล้ว ถัดไปที่ __VAR_0__"
    ...
    DB_FIREBASE_CACHE_NOT_FOUND_MSG = "⚠️ ไม่พบไฟล์แคช Firebase โดยเริ่มต้นด้วยแคชว่าง: __VAR_0__"
    DB_FAILED_LOAD_FIREBASE_CACHE_MSG = "❌ ไม่สามารถโหลดแคช firebase: {error}"
    DB_FIREBASE_CACHE_RELOADED_MSG = "✅ โหลดแคช Firebase แล้ว: __VAR_0__ โหนดรูท"
    DB_FIREBASE_CACHE_FILE_NOT_FOUND_MSG = "⚠️ ไม่พบไฟล์แคช Firebase: __VAR_0__"
    DB_FAILED_RELOAD_FIREBASE_CACHE_MSG = "❌ ไม่สามารถโหลดแคช firebase ใหม่ได้: __VAR_0__"
    
    # Database user ban messages
    DB_USER_BANNED_MSG = "🚫 คุณถูกแบนจากบอท!"
    ...
    HELPER_CHECK_SUBS_LIMITS_INFO_DICT_KEYS_MSG = "check_subs_limits: คีย์ info_dict: __VAR_0__"
    ...
    HELPER_POT_URL_NOT_YOUTUBE_MSG = "URL __VAR_0__ ไม่ใช่โดเมน YouTube กำลังข้ามโทเค็น PO"
    HELPER_POT_PROVIDER_NOT_AVAILABLE_MSG = "ผู้ให้บริการโทเค็น PO ไม่พร้อมให้บริการที่ __VAR_0__ โดยจะกลับไปใช้การแยก YouTube แบบมาตรฐาน"
    ...
    HELPER_MSG_SEQNO_ERROR_DETECTED_MSG = "ตรวจพบข้อผิดพลาด msg_seqno เข้าสู่โหมดสลีปเป็นเวลา __VAR_0__ วินาที"
