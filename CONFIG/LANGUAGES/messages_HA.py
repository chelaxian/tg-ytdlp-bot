...
Koyi ƙari: /playlist"""
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Ma'ajiyar batsa ta admin {admin_id}. Yankunan: {domains}, Kalmomin: {keywords}, Shafukan: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>Available services depend on bot configuration.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Tsohon yaren kade-kade (wakar sauti)"
