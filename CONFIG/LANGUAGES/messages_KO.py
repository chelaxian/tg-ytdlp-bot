...
자세히 알아보기: /playlist"""
    ...
    ALWAYS_ASK_SUB_BURN_PAID_MSG = "⭐️ — 하드번 자막은 유료입니다: 144p: 1⭐ | 240p: 2⭐ | 360p: 3⭐ | 480p: 4⭐ | 720p: 5⭐ | 1080p+: 관리자 전용"
    ...
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>MKV/AV1/VP9 동영상</b>\n이 동영상을 재생하려면 Telegram 디버그 메뉴에서 <b>PlayerV2</b>를 활성화하세요:\n\n📱 <b>iOS</b>: Settings → 10번 탭 → 아래로 스크롤 → PlayerV2 활성화\n🤖 <b>Android</b>: Settings → 아래로 스크롤 → \"Telegram v X.X.X\" 길게 두 번 누름 → PlayerV2 활성화"
...
<i>사용 가능한 서비스는 봇 구성에 따라 다릅니다.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - 기본 더빙(오디오 트랙) 언어"
    ...
    DUBS_SETTINGS_MENU_MSG = "🗣 <b>더빙(오디오 트랙) 설정</b>\n\n{status_text}\n\n더빙 언어 선택:\n\n"
