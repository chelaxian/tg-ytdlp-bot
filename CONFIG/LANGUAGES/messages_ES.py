...
• <code>/nsfw off</code> - habilitar desenfoque
    ...
    PROXY_MENU_TEXT_MULTIPLE_MSG = "¿Habilitar o deshabilitar el uso de servidores proxy ({count} disponibles) para todas las operaciones de yt-dlp?\n\nCuando esté habilitado, los proxies se seleccionarán usando el método {method}."
    ...
    ALWAYS_ASK_WATCH_VIDEO_MSG = "👁 — Ver video en poketube"
    ...
    DB_USER_BANNED_MSG = "🚫 ¡Estás baneado del bot!"
...
<i>Los servicios disponibles dependen de la configuración del bot.</i>"""
    ...
    ALWAYS_ASK_WATCH_BUTTON_MSG = "👁Ver"
