...
بیشتر بدانید: /playlist"""
    ...
    PROXY_COUNTRY_NOT_AVAILABLE_MSG = "❌ پراکسی برای این کشور در دسترس نیست. کشور دیگری امتحان کنید."
    PROXY_COUNTRY_SET_BY_COMMAND_MSG = "✅ پراکسی تنظیم شد: کشور {country} (کد: {country_code})"
...
<i>سرویس‌های موجود بستگی به پیکربندی ربات دارد.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - زبان دوبله پیش‌فرض (تراک صوتی)"
    ...
    DUBS_SETTINGS_MENU_MSG = "🗣 <b>تنظیمات دوبله (قطعه صوتی)</b>\n\n{status_text}\n\nزبان دوبله را انتخاب کنید:\n\n"
