...
• <code>/nsfw off</code> - ativar desfoque
    ...
    UPLOAD_ALREADY_IN_PROGRESS_MSG = "⏳ Este vídeo já está sendo enviado. Aguarde a conclusão do envio atual."
    FLOOD_WAIT_USER_MSG = "Telegram exige espera antes do envio. O bot continuará automaticamente após o término do temporizador ({time_str})."
...
Saiba mais: /playlist"""
    ...
    PROXY_COUNTRY_NOT_AVAILABLE_MSG = "❌ Proxy não disponível para este país. Tente outro país."
    PROXY_COUNTRY_SET_BY_COMMAND_MSG = "✅ Proxy definido: país {country} (código: {country_code})"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Caches porn recarregados por administrador {admin_id}. Domains: {domains}, Keywords: {keywords}, Sites: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>Serviços disponíveis dependem da configuração do bot.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Idioma de dublagem (faixa de audio) padrao"
    ...
    DUBS_SETTINGS_MENU_MSG = "🗣 <b>Configurações de dublagem (faixa de áudio)</b>\n\n{status_text}\n\nSelecionar idioma de dublagem:\n\n"
