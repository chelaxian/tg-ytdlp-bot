...
• <code>/nsfw off</code> - abilita sfocatura
    ...
    UPLOAD_ALREADY_IN_PROGRESS_MSG = "⏳ Questo video è già in fase di caricamento. Attendi il completamento del caricamento corrente."
    FLOOD_WAIT_USER_MSG = "Telegram richiede di attendere prima dell'invio. Il bot continuerà automaticamente dopo la scadenza del timer ({time_str})."
...
Scopri di più: /playlist"""
    ...
    PROXY_ENABLED_ALL_AUTO_MSG = "✅ Proxy abilitato (AUTO su errore YouTube).\n\nIn caso di errore di geo-blocco YouTube, il bot userà solo proxy dei paesi indicati nell'errore (nessun tentativo sequenziale di tutti i proxy)."
    PROXY_DISABLED_MSG = "❌Proxy disabilitato."
    PROXY_TRYING_COUNTRY_MSG = "🔄 Prova proxy: {country} ({current}/{total})"
    ...
    FORMAT_RESOLUTION_MENU_MSG = "Seleziona la risoluzione e il codec desiderati:\n\n⚠️ <b>MKV/AV1/VP9:</b> Per la riproduzione, attiva <b>PlayerV2</b> nel menu Debug di Telegram:\n📱 iOS: Settings → tocca 10 volte → interruttore PlayerV2\n🤖 Android: Settings → tieni premuto \"Telegram v X.X.X\" due volte → menu Debug"
    FORMAT_ALWAYS_ASK_CONFIRM_MSG = "✅ Format set to: Always Ask. Now you will be prompted for quality each time you send a URL."
    ...
    ALWAYS_ASK_SUB_BURN_PAID_MSG = "⭐️ — I sottotitoli incorporati sono a pagamento: 144p: 1⭐ | 240p: 2⭐ | 360p: 3⭐ | 480p: 4⭐ | 720p: 5⭐ | 1080p+: solo admin"
    ...
    ALWAYS_ASK_MKV_PLAYER_HINT_MSG = "⚠️ MKV/AV1/VP9: abilita PlayerV2 nel menu Debug di Telegram per la riproduzione\niOS: 10 tocchi su Settings → scorrere in basso → attiva PlayerV2\nAndroid: Settings → pressione lunga due volte su \"Telegram v X.X.X\" → menu Debug"
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>Video MKV/AV1/VP9</b>\nPer riprodurre questo video, abilita <b>PlayerV2</b> nel menu Debug di Telegram:\n\n📱 <b>iOS</b>: Settings → 10 tocchi → scorrere in basso → abilita PlayerV2\n🤖 <b>Android</b>: Settings → scorrere in basso → pressione lunga due volte su \"Telegram v X.X.X\" → abilita PlayerV2"
    ...
    PROXY_ON_BUTTON_MSG = "✅ AUTO (su errore YouTube)"
    ...
    PROXY_COUNTRY_NOT_AVAILABLE_MSG = "❌ Proxy non disponibile per questo paese. Prova un altro paese."
    PROXY_COUNTRY_SET_BY_COMMAND_MSG = "✅ Proxy impostato: paese {country} (codice: {country_code})"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Cache porno ricaricate dall'amministratore {admin_id}. Domini: {domains}, Parole chiave: {keywords}, Siti: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>Available services depend on bot configuration.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Lingua di doppiaggio (traccia audio) predefinita"
