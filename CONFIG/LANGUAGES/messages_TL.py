...
Matuto pa: /playlist"""
    ...
    ALWAYS_ASK_MKV_PLAYER_HINT_MSG = "⚠️ MKV/AV1/VP9: i-enable ang PlayerV2 sa Telegram Debug menu para sa inline playback\niOS: I-tap ang Settings nang 10 beses → mag-scroll pababa → i-toggle ang PlayerV2\nAndroid: Settings → pindutin nang matagal nang dalawang beses ang \"Telegram v X.X.X\" → Debug menu"
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>Video ng MKV/AV1/VP9</b>\nUpang i-play ang video na ito, i-enable ang <b>PlayerV2</b> sa Telegram Debug menu:\n\n📱 <b>iOS</b>: Settings → i-tap nang 10 beses → mag-scroll pababa → i-enable ang PlayerV2\n🤖 <b>Android</b>: Settings → mag-scroll pababa → pindutin nang matagal nang dalawang beses ang \"Telegram v X.X.X\" → i-enable ang PlayerV2"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Mga porn cache na na-reload ng admin {admin_id}. Mga Domain: {domains}, Mga Keyword: {keywords}, Mga Site: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>Ang available na serbisyo ay depende sa bot configuration.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Default na wika ng dubbing (audio track)"
