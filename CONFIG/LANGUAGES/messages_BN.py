...
• <code>/nsfw off</code> - ব্লার সক্ষম করুন
    ...
    PROXY_MENU_TEXT_MULTIPLE_MSG = "সমস্ত yt-dlp অপারেশনের জন্য proxy সার্ভার ({count} উপলব্ধ) ব্যবহার সক্ষম বা অক্ষম করবেন?\n\nসক্ষম হলে, {method} পদ্ধতি ব্যবহার করে proxy নির্বাচন করা হবে।"
    ...
    ALWAYS_ASK_WATCH_VIDEO_MSG = "👁 — poketube এ ভিডিও দেখুন"
    ...
    PORN_CONTENT_CANNOT_DOWNLOAD_MSG = "ব্যবহারকারী একটি পর্ন কন্টেন্ট প্রবেশ করেছেন। ডাউনলোড করা যাবে না।"
    ...
    DB_USER_BANNED_MSG = "🚫 আপনি বট থেকে নিষিদ্ধ!"
