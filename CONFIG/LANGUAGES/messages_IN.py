...
अधिक जानें: /playlist"""
    ...
    ALWAYS_ASK_MKV_PLAYER_HINT_MSG = "⚠️ MKV/AV1/VP9: इनलाइन प्लेबैक के लिए Telegram डीबग मेनू में PlayerV2 सक्षम करें\niOS: Settings पर 10 बार टैप करें → नीचे स्क्रॉल करें → PlayerV2 टॉगल करें\nAndroid: Settings → \"Telegram v X.X.X\" पर दो बार देर तक दबाएं → डीबग मेनू"
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>MKV/AV1/VP9 वीडियो</b>\nइस वीडियो को चलाने के लिए, Telegram डीबग मेनू में <b>PlayerV2</b> सक्षम करें:\n\n📱 <b>iOS</b>: Settings → 10 बार टैप करें → नीचे स्क्रॉल करें → PlayerV2 सक्षम करें\n🤖 <b>Android</b>: Settings → नीचे स्क्रॉल करें → \"Telegram v X.X.X\" पर दो बार देर तक दबाएं → PlayerV2 सक्षम करें"
    ...
    PROXY_COUNTRY_NOT_AVAILABLE_MSG = "❌ इस देश के लिए प्रॉक्सी उपलब्ध नहीं। किसी अन्य देश को आज़माएं।"
    PROXY_COUNTRY_SET_BY_COMMAND_MSG = "✅ प्रॉक्सी सेट: देश {country} (कोड: {country_code})"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "व्यवस्थापक {admin_id} द्वारा पोर्न कैश रीलोड किए गए। डोमेन: {domains}, कीवर्ड: {keywords}, साइटें: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
...
<i>उपलब्ध सेवाएं बॉट कॉन्फ़िगरेशन पर निर्भर करती हैं।</i>"""
    ...
    DUBS_SETTINGS_MENU_MSG = "🗣 <b>डबिंग (ऑडियो ट्रैक) सेटिंग्स</b>\n\n{status_text}\n\nडबिंग भाषा चुनें:\n\n"
