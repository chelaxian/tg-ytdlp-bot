...
• <code>/nsfw off</code> - enable blur
    ...
    UPLOAD_ALREADY_IN_PROGRESS_MSG = "⏳ This video is already being uploaded. Please wait for the current upload to complete."
    FLOOD_WAIT_USER_MSG = "Telegram requires waiting before sending. The bot will automatically continue after the timer expires ({time_str})."
    ...
    PLAYLIST_AUTO_RANGE_HINT_MSG = """💡 <b>Playlist Tip</b>

You sent a playlist link without specifying a range. The bot automatically downloaded the first video (<code>*1*1</code>).

<b>To download multiple videos from a playlist, specify a range:</b>
• <code>URL*1*5</code> — first 5 videos (from 1 to 5 inclusive)
...
Learn more: /playlist"""
    ...
    ALWAYS_ASK_RECENTLY_FAILED_MSG = "⏳ This link was already tried recently and failed. Please wait a few minutes before trying again."
    ...
    ALWAYS_ASK_SUB_BURN_PAID_MSG = "⭐️ — Hard-burned subtitles are paid: 144p: 1⭐ | 240p: 2⭐ | 360p: 3⭐ | 480p: 4⭐ | 720p: 5⭐ | 1080p+: admin only"
    ...
    ALWAYS_ASK_MKV_PLAYER_HINT_MSG = "⚠️ MKV/AV1/VP9: enable PlayerV2 in Telegram Debug menu to play inline\niOS: 10 taps Settings → scroll down → toggle PlayerV2\nAndroid: Settings → long-press twice \"Telegram v X.X.X\" → Debug menu"
    MKV_PLAYER_HINT_SENT_MSG = "⚠️ <b>MKV/AV1/VP9 video</b>\nTo play this video inline, enable <b>PlayerV2</b> in Telegram Debug menu:\n\n📱 <b>iOS</b>: Settings → tap 10 times → scroll down → enable PlayerV2\n🤖 <b>Android</b>: Settings → scroll down → long-press twice \"Telegram v X.X.X\" → enable PlayerV2"
    SAVE_AS_COOKIE_HINT_MSG = "🔐 <b>Authentication error</b>\nThis video requires login cookies. You can provide your browser cookies using the /cookie command:\n\n1️⃣ Send <code>/cookie</code> to get instructions\n2️⃣ Export cookies from your browser\n3️⃣ Send the cookie file to the bot\n\nThis helps bypass age verification and bot detection."
    ...
    FILE_PROCESSING_ERROR_NON_VIDEO_FILE_MSG = (
        "**Reason:**\n"
        "• The downloaded file is not a video file\n"
        "• It might be a document (PDF, DOC, etc.) or archive\n\n"
        "**Solution:**\n"
    ...
    FILE_PROCESSING_ERROR_INVALID_DATA_MSG = (
        "**Reason:**\n"
        "• The file cannot be processed as video\n"
        "• It might not be a video file or the file is corrupted\n\n"
        "**Solution:**\n"
        "• Check the link - it might lead to a document, not a video\n"
        "• Try a different link or source\n"
    )
    ...
    PROXY_COUNTRY_NOT_AVAILABLE_MSG = "❌ Proxy is not available for this country. Try another country."
    PROXY_COUNTRY_SET_BY_COMMAND_MSG = "✅ Proxy set to country: {country} (code: {country_code})"
    ...
    ADMIN_PORN_CACHE_RELOADED_MSG = "Porn caches reloaded by admin {admin_id}. Domains: {domains}, Keywords: {keywords}, Sites: {sites}, WHITELIST: {whitelist}, GREYLIST: {greylist}, BLACK_LIST: {black_list}, WHITE_KEYWORDS: {white_keywords}, PROXY_1_DOMAINS: {proxy_domains}, PROXY_2_DOMAINS: {proxy_2_domains}, CLEAN_QUERY: {clean_query}, NO_COOKIE_DOMAINS: {no_cookie_domains}, NO_PROXY_DOMAINS: {no_proxy_domains}, AUTO_PROXY_DOMAINS: {auto_proxy_domains}, YTDLP_ONLY_DOMAINS: {ytdlp_only_domains}, GALLERYDL_ONLY_DOMAINS: {gallerydl_only_domains}, GALLERYDL_ONLY_PATH: {gallerydl_only_path}, GALLERYDL_FALLBACK_DOMAINS: {gallerydl_fallback_domains}, NO_FILTER_DOMAINS: {no_filter_domains}, TIKTOK_DOMAINS: {tiktok_domains}"
    ...
    DB_USER_BANNED_MSG = f"🚫 You are banned from the bot! To unban, contact {Config.ADMIN_USERNAME}\n<blockquote>P.S. Do not leave the channel - you will be automatically banned ⛔️</blockquote>\n🌍Change language /lang"
...
<i>Available services depend on bot configuration.</i>"""
    ...
    SETTINGS_DUBS_CMD_BUTTON_MSG = "🗣 /dubs - Default dub (audio track) language"
    ...
    DUBS_SETTINGS_MENU_MSG = "🗣 <b>Dub (audio track) settings</b>\n\n{status_text}\n\nSelect dub language:\n\n"
