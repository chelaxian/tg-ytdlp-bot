class LoggerMsg(object):
    ...
    PROXY_CMD_PROXY_DOMAINS_LOG_MSG = "PROXY_1_DOMAINS: {domains}"
    PROXY_CMD_DOMAIN_FOUND_IN_PROXY_2_LOG_MSG = "Domain {domain} found in PROXY_2_DOMAINS (or is subdomain), using proxy 2"
    PROXY_CMD_DOMAIN_FOUND_IN_PROXY_1_LOG_MSG = "Domain {domain} found in PROXY_1_DOMAINS (or is subdomain), using proxy 1"
