...
class LimitsConfig(object):
    ...
    def detect_system_resources():
        ...
        max_uploads = min(max(cpu_count + 2, 2), 8)
    ...
    ANTI_BOT_DUPLICATE_URL_LIMIT = 20 # 20 одинаковых ссылок
    ...
    ANTI_BOT_TIMER_INTERVAL_MIN_COUNT = 15  # минимум 15 сообщений с одинаковым интервалом
    ...
    # Proxy retry limits
    #######################################################
    # Максимальное количество прокси, перебираемых в рамках одной страны
    # при обработке одной задачи скачивания (один URL)
