...
class LimitsConfig(object):
    ...
    # Максимальное количество разных часов в течение дня, когда пользователь проявлял активность
    ANTI_BOT_24H_ACTIVITY_LIMIT = 24  # активность в каждый из 24 часов
    # Период для проверки активности 24/7 (в секундах)
    ANTI_BOT_24H_WINDOW = 86400  # 24 часа (1 день)
