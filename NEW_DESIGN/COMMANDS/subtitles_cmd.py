...
@on_message(filters.command("subs") & filters.private)
@reply_with_keyboard
...
@on_callback_query(filters.regex(r"^subs_page\|"))
...
@on_callback_query(filters.regex(r"^subs_lang\|"))
...
@on_callback_query(filters.regex(r"^subs_auto\|"))
...
@on_callback_query(filters.regex(r"^subs_lang_close\|"))
