...
### Step 3.5: Install Node.js and PhantomJS (recommended)

Node.js is required by yt-dlp for JavaScript runtime (YouTube and other sites).
PhantomJS is required for some sites like PornHub.

```bash
# Install Node.js (yt-dlp JS runtime for YouTube extraction)
