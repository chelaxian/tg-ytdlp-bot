...
def embed_subs_to_video(video_path, user_id, tg_update_callback=None, app=None, message=None):
    ...
    try:
        ...
        filter_arg = f"subtitles='{subs_path_escaped}':force_style='FontSize=24,PrimaryColour=&Hffffff,OutlineColour=&H80000000,BackColour=&H80000000,Outline=2,Shadow=1,MarginV=25'"
        cmd = [
            'ffmpeg',
            '-y',
            '-i', video_path,
